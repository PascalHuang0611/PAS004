...
def run_simulation(buffer_min=None, buffer_max=None, pre_fund=None, output_path=None):
    ...
    if output_path is None:
        ...
        json_path = os.path.join(current_dir, 'simulation_f_log.json')
    else:
    ...
    print(f"系統F設定: Base Buffer {base_buf_min}~{base_buf_max}, Pre-fund: {pre_ratio*100}%")
